...
@dataclass()
class FeatureParams:
    categorical_features: List[str] = field(default_factory=lambda: DEFAULT_CATEGORICAL_FEATURES)
    numerical_features: List[str] = field(default_factory=lambda: DEFAULT_NUMERICAL_FEATURES)
